...
export default {
  ...
  methods: {
    ...
    getTaskDescription() {
      return "Diese Aufgabe soll dir das Binärsystem beibringen. Du hast eine Zahl gegeben. Weiter hast du eine 32, 16, 8, 4, 2 und 1 Karte gegeben. Welche von diesen Karten benötigst du, damit die Summe der Karten genau der gesuchten Zahl entspricht? Der Trick ist, immer die grösstmögliche Karte zu probieren, dann die nächstkleinere und so weiter. Klicke auf eine Karte, falls sie in Frage kommen sollte, um die Zahl im Binärsystem darzustellen."
    },
    showHint() {
      this.hint = true;
    },
